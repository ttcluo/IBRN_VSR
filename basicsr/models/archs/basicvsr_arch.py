...
from basicsr.models.archs.arch_util import ResidualBlockNoBN, flow_warp1, make_layer
...
class BasicVSR(nn.Module):
    ...
    Args:
        ...
        spynet_path (str): The path of Pre-trained SPyNet model.
            Default: None.
    """
    def __init__(self, num_feat=64, num_block=30, spynet_path=None, resType="ResidualBlockNoBN"):
        ...
        self.forward_resblocks = ConvResBlock(num_feat + 3, num_feat, num_block, resType)
    ...
    def forward(self, lrs):
        ...
        for i in range(t-1, -1, -1):
            ...
            if i < t-1:
                ...
                feat_prop = flow_warp1(feat_prop, flow.permute(0, 2, 3, 1))
