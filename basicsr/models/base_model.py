...
class BaseModel():
    ...
    @master_only
    def save_latest_network(self, net, param_key='params'):
        """Save networks.
    ...
    def load_network(self, net, load_path, strict=True, param_key='params'):
        ...
        for k, v in deepcopy(load_net).items():
            ...
            if 'conv_offset_mask' in k:
                load_net[k.replace('conv_offset_mask', 'conv_offset')] = v
                load_net.pop(k)
            if "ca." in k:
                print(k)
                load_net[k.replace("ca.", "attn.")] = v
                load_net.pop(k)
    ...
    @master_only
    def save_latest_state(self, epoch, current_iter):
        """Save training states during training, which will be used for
        resuming.
